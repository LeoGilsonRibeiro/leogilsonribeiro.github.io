...
date: 2022
view_url: https://www.leogilsonribeiro.com.br/introducao/03-carlo-emilio-gadda/00-gadda-(1893-1973)
edit_url: https://github.com/LeoGilsonRibeiro/leogilsonribeiro.github.io/edit/main//docs/markdown/introducao/03-carlo-emilio-gadda/00-gadda-(1893-1973).md
commits_url: https://github.com/LeoGilsonRibeiro/leogilsonribeiro.github.io/commits/main/docs/markdown/introducao/03-carlo-emilio-gadda/00-gadda-(1893-1973).md
...
=== "ABNT"
    RIBEIRO, Leo Gilson. "Gadda (1893-1973)". In PUENTE, Fernando Rey (org.) <em>Textos Reunidos de Leo Gilson Ribeiro, Introdução</em>, 2022. Publicação original: Veja, 1973/05/30. URL: <a href="stable_url">https://www.leogilsonribeiro.com.br/introducao/03-carlo-emilio-gadda/00-gadda-(1893-1973)</a>
...
=== "BibTeX"
    ...
    date = {2022},
    url = {https://www.leogilsonribeiro.com.br/introducao/03-carlo-emilio-gadda/00-gadda-(1893-1973)},
    orig_publisher = {'Veja'},
    orig_date = {1973/05/30}
    }
    ```
...
=== "RIS"
    ...
    PB  - 'Veja'
    Y1  - 1973/05/30
    UR  - https://www.leogilsonribeiro.com.br/introducao/03-carlo-emilio-gadda/00-gadda-(1893-1973)
    ER  - 
    ```
